...
export const LogOut = ({logOut}) => {
  ...
  return (
    <div className="flex justify-center space-x-5 items-center">
      ...
      {
        user.photoURL ? <img className="rounded-full w-14" width={1080} height={720} src={user?.photoURL} alt="" /> : <img src={profile} className="rounded-full w-14" width={1080} height={720} alt="demo"/>
      }
    </div>
  );
};
