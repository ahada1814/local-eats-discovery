...
const AddItems = () => {
    return (
        <div className="flex flex-col items-start justify-start gap-3 w-[60%] ps-20">
            ...
            <input type="submit" value="Update" className="bg-[#FFC153] px-6 py-2 text-white font-semibold rounded-md"/>
        </div>
    );
};
